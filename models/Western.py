...
info = {
    'titles': 'Multivariate Analysis of Income per (GPD/Capita) in Europe', 
    'x': '', 
    'y': '', 
    'file': 'data/Western.csv'
}
...
print("")
# plot the results
multivariate_analysis.plot(colmap=ListedColormap(['red', 'blue','yellow','green']))
